const calculations = require('./src/index');
const { percentages, fixValues } = require('./src/values');
...
test('should return taxfree income if small profit', () => {
  ...
  expect(calculations(income, 0)).toStrictEqual({
    est: 0,
    netto: income - uv,
    sv: uv,
